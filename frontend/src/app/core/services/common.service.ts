...
export abstract class CommonService<E extends Generic> {
    ...
    public getAll(): Observable<E[]> {
      return this.http.get<E[]>(`${environment.urlBackendSpringBoot}`, { headers: this.headers });
    }
...
/*       const params = new HttpParams()
        .set('page', page)
        .set('size', size) */
      return this.http.get<any>(`${this.baseEnpoint}/page/${page}/${size}`, { headers: this.headers });
    }
...
/*       const params = new HttpParams()
        ...
        .set('size', size)
        .set('text', text) */
      return this.http.get<any>(`${this.baseEnpoint}/page/${page}/${size}/${text}`, { headers: this.headers });
    }

    public getById(id: number): Observable<E> {
      return this.http.get<E>(`${this.baseEnpoint}/${id}`, { headers: this.headers });
    }
    ...
    public delete(id: number): Observable<E> {
      return this.http.delete<E>(`${this.baseEnpoint}/${id}`, { headers: this.headers })
    }

    public enable(id: number, enable: Boolean): Observable<any>{
      return this.http.get<E>(`${this.baseEnpoint}/${id}/${enable}`, { headers: this.headers })
    }
